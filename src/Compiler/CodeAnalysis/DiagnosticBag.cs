...
namespace Compiler.CodeAnalysis
{
    internal sealed class DiagnosticBag : IEnumerable<Diagnostic>
    {
        ...
        public void ReportRequiredTypeNotFound(string? CompilerName, string metadataName)
        {
            var message = CompilerName == null
                ? $"The required type '{metadataName}' cannot be resolved among the given references."
                : $"The required type '{CompilerName}' ('{metadataName}') cannot be resolved among the given references.";
            ReportError(default, message);
        }

        public void ReportRequiredTypeAmbiguous(string? CompilerName, string metadataName, TypeDefinition[] foundTypes)
        {
            ...
            var message = CompilerName == null
                ...
                : $"The required type '{CompilerName}' ('{metadataName}') was found in multiple references: {assemblyNameList}.";
            ReportError(default, message);
        }
