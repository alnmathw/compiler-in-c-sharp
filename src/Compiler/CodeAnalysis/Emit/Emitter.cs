...
namespace Compiler.CodeAnalysis.Emit
{
    internal sealed class Emitter
    {
        ...
        private Emitter(string moduleName, string[] references)
        {
            ...
            TypeReference ResolveType(string? CompilerName, string metadataName)
            {
                ...
                {
                    _diagnostics.ReportRequiredTypeNotFound(CompilerName, metadataName);
                }
                else
                {
                    _diagnostics.ReportRequiredTypeAmbiguous(CompilerName, metadataName, foundTypes);
                }
